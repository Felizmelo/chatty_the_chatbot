...
export const Chat = ({ store_props, userMessage, sendMessage }) => {
    ...
    const askQuestion = (question) => {
        ...
        if (question.type === "radio") {
            sendMessage("Por favor escolha um")
            ...
            sendMessage("Por favor escreva sua resposta")
        }
    ...
    const validateResponse = (response) => {
        ...
        if (questionInQueue.type === "radio") {
            ...
            if (!capitalizedOptions.includes(response.toUpperCase())) {
                sendMessage("Opa, eu não entendi ... Você pode dizer isso de novo")
        ...
        sendMessage("Ooooo....")
        sendMessage("Essa é uma boa escolha")
    ...
    const getNextQuestion = async (response, question_index) => {
        ...
        if (nextQuestion === undefined) {
            sendMessage("Foi legal conversar com você:D")
            sendMessage("Estou cansado eu vou para cama, até logo ...")
            sendMessage("Adeus... :P")
            return
        }
